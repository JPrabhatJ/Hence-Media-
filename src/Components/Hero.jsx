...
<section id="campaign" className="py-16 bg-white">
  ...
  {/* Section 1 */}
   <div className="flex flex-col md:flex-row items-center mb-16 max-w-6xl mx-auto">
   <div className="md:w-1/2 p-4">
  <img src="src/assets/Dhoni.webp" alt="Campaign Image" className="w-full rounded-lg" />
</div>

    <div className="md:w-1/2 p-4">
     <h2 className="text-2xl font-bold text-center mb-12 relative inline-block">
  <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-purple-600">BOLE JO KOYAL TREND</span>☠️
  <span className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-full h-1 bg-red-600 shadow-xl rounded-lg mt-2"></span>
    ...
    <div className="flex flex-col md:flex-row items-center mb-16 max-w-6xl mx-auto">
   <div className="md:w-1/2 p-4">
  <img src="public/BB(Hence).jpg" alt="Campaign Image" className="w-full rounded-lg" />
</div>

    <div className="md:w-1/2 p-4">
    <h2 className="text-2xl font-bold text-center mb-12 relative inline-block">
  <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-purple-600">BIG BOSS TWITTER TREND</span>😈
  <span className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-full h-1 bg-red-600 shadow-xl rounded-lg mt-2"></span>
</h2>
    <p className="text-gray-700">
  ...
  <img src="/Panchayat.webp" alt="Campaign Image" className="w-full rounded-lg" />
    ...
    <div className="md:w-1/2 p-4">
 <h2 className="text-2xl font-bold text-center mb-12 relative inline-block">
  <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-purple-600">PANCHAYAT</span>😍
  <span className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-full h-1 bg-red-600 shadow-xl rounded-lg mt-2"></span>
</h2>
    <p className="text-gray-700">
  ...
  <img src="/Narzo(Hence).webp" alt="Campaign Image" className="w-full rounded-lg" />
    ...
    <div className="md:w-1/2 p-4">
     <h2 className="text-2xl font-bold text-center mb-12 relative inline-block">
  <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-purple-600">NARZO PHONE LAUNCH</span>🤩
  <span className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-full h-1 bg-red-600 shadow-xl rounded-lg mt-2"></span>
</h2>
    <p className="text-gray-700">
     "The Narzo Phone Ad campaign, executed in collaboration with Hence Media, achieved an outstanding 45Million+ reach and 28Million+ engagement, leveraging the power of meme and influencer marketing. Through a strategic seeding activity on Instagram, we sparked viral conversations, driving massive organic traction without influencer collaborations. This campaign not only amplified brand awareness but also set a new benchmark for engagement-driven marketing."
    </p>
  </div>
  </div>
 ...
 <div className="flex flex-col md:flex-row items-center mb-16 max-w-6xl mx-auto">
  ...
  <img src="/KKK(Hence).avif" alt="Campaign Image" className="w-full rounded-lg" />
    ...
    <div className="md:w-1/2 p-4">
 <h2 className="text-2xl font-bold text-center mb-12 relative inline-block">
  <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-purple-600">KHATRO KE KHILADI</span>🥵
  <span className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-full h-1 bg-red-600 shadow-xl rounded-lg mt-2"></span>
</h2>
    <p className="text-gray-700">
      "For our latest KHATRO KE KHILADI  CAMPAIGN (Hence Media) set out with an ambitious promise of achieving a 30 million reach. Through strategic & reel promotion across a 200 million follower base, we surpassed expectations, delivering an impressive 50 million+ reach. Our success reflects our commitment to delivering exceptional results and creating impactful campaigns that resonate peridotmedia.in hits 100 million followers base, showcasing its Meme Marketing campaign that reached 50 million people. The platform’s engaging, multi- platform approach cemented its place as a leader in digital entertainment marketing."
    </p>
  </div>
  </div>
</section>
...
<section className="py-16 bg-white">
  ...
  <Marquee speed={50} pauseOnHover gradient={false}>
    <img src="src/assets/TVF.jpg" alt="Client 1" className="h-16 mx-8" />
    <img src="src/assets/Realme.webp" alt="Client 2" className="h-16 mx-8" />
    <img src="src/assets/Hotstar.jpeg" alt="Client 3" className="h-16 mx-8" />
    <img src="src/assets/keshKing.png" alt="Client 4" className="h-16 mx-8" />
    <img src="src/assets/new Colors.jpg" alt="Client 5" className="h-16 mx-8" />
    <img src="src/assets/DMF.jpg" alt="Client 6" className="h-16 mx-8" />
    <img src="src/assets/Acer.jpg" alt="Client 7" className="h-16 mx-8" />
    <img src="src/assets/primevideo.png" alt="Client 8" className="h-16 mx-8" />
    <img src="src/assets/Paytm.avif" alt="Client 9" className="h-16 mx-8" />
    <img src="src/assets/Dream11.jpg" alt="Client 10" className="h-16 mx-8" />
  </Marquee>
  ...
  <div className="relative mt-12">
    <Marquee speed={50} pauseOnHover gradient={false} direction="rtl">
      <img src="src/assets/pubg.webp" alt="Client 1" className="h-16 mx-8" />
      <img src="src/assets/Woodland.png" alt="Client 2" className="h-16 mx-8" />
      <img src="src/assets/Sony.png" alt="Client 3" className="h-16 mx-8" />
      <img src="src/assets/Xiaomi-Logo.png" alt="Client 4" className="h-16 mx-8" />
      <img src="src/assets/Tseries.jpg" alt="Client 5" className="h-16 mx-8" />
      <img src="src/assets/Cadbury_Logo.png" alt="Client 6" className="h-16 mx-8" />
      <img src="src/assets/Flipkart.png" alt="Client 7" className="h-16 mx-8" />
      <img src="src/assets/Loco.jpg" alt="Client 8" className="h-16 mx-8" />
      <img src="public/Netflix.jpg" alt="Client 9" className="h-16 mx-8" />
      <img src="src/assets/cashify.png" alt="Client 10" className="h-16 mx-8" />
    </Marquee>
  </div>
</section>
  ...
  <div className="w-1/2 p-4">
    <img 
      src="public/WhatsApp Image 2025-06-09 at 12.21.43 PM.jpeg" 
